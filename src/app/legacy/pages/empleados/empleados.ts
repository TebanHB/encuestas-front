...
@Component({
    ...
    template: `
        <div class="empleados-page">
            <section class="employees-hero card">
                <div class="employees-hero__content">
                    <div>
                        <div class="hero-chip">AdministraciÃ³n</div>
                        <h1 class="hero-title">GestiÃ³n de empleados</h1>
                        <p class="hero-subtitle">Administra los usuarios que tendrÃ¡n acceso al sistema, sus roles, estado y permisos de creaciÃ³n de encuestas.</p>
                    </div>
            ...
            <section class="card employees-table-card">
                <div class="table-header">
                    <div>
                        ...
                        <p>Visualiza rÃ¡pidamente el estado, el rol y los permisos de cada usuario.</p>
                    </div>
                </div>
                ...
                <p-table [value]="empleados" [tableStyle]="{ 'min-width': '72rem' }" responsiveLayout="scroll">
                    ...
                    <ng-template pTemplate="body" let-empleado>
                        <tr>
                                ...
                                <div class="employee-cell">
                                    ...
                                    <div>
                                        <div class="employee-name">
                                            ...
                                            <span *ngIf="esUsuarioActual(empleado)" class="self-badge">TÃº</span>
                                        </div>
                            ...
                            <td>
                                <p-tag [value]="empleado.puedeCrearEncuestas ? 'SÃ­' : 'No'" [severity]="empleado.puedeCrearEncuestas ? 'info' : 'contrast'"></p-tag>
                            </td>
                ...
                <div class="form-section">
                    ...
                    <div class="dialog-grid">
                        <div class="field-block">
                            ...
                            <small class="field-help">Debe ser un correo vÃ¡lido.</small>
                        ...
                        <div class="field-block">
                            ...
                            <small class="field-help">MÃ­nimo 5 caracteres.</small>
        ...
        >
            <div class="dialog-form pt-2">
                <div class="form-section">
                    ...
                    <div class="dialog-grid dialog-grid--single">
                        ...
                        <div class="field-block">
                            <label class="field-label">Confirmar contraseÃ±a *</label>
            ...
            <ng-template pTemplate="footer">
                <div class="flex justify-content-end gap-2">
                    ...
                    <button pButton type="button" [label]="cambiandoPassword ? 'Guardando...' : 'Cambiar contraseÃ±a'" (click)="cambiarPassword()" [disabled]="cambiandoPassword"></button>
                </div>
            </ng-template>
        </p-dialog>
        ...
        >
            <div class="pt-2">
                <p class="m-0">
                    Â¿EstÃ¡s seguro de eliminar a este {{ getTipoUsuarioLabel(empleadoSeleccionado) }}:
                    <strong>{{ empleadoSeleccionado?.nombre }} {{ empleadoSeleccionado?.apellido }}</strong
                    >?
                </p>

                <p class="mt-3 mb-0 text-600">Se quitarÃ¡ de la interfaz, pero seguirÃ¡ guardado en la base de datos.</p>
...
export class Empleados implements OnInit {
    ...
    cambiarPassword(): void {
        ...
        this.empleadoService.cambiarPassword(this.cambiarPasswordForm.id, payload).subscribe({
            ...
            error: (error) => {
                ...
                this.errorCambiarPassword = this.obtenerMensajeError(error, 'No se pudo cambiar la contraseÃ±a.');
                this.cambiandoPassword = false;
                this.cdr.detectChanges();
            }
        });
    ...
    confirmarEliminarEmpleado(empleado: Empleado): void {
        if (!this.puedeEliminarEmpleado(empleado)) {
            this.errorMessage = this.esUsuarioActual(empleado)
                ? 'No puedes eliminar el usuario con el que tienes la sesiÃ³n iniciada.'
    ...
    private validarNuevoEmpleado(): boolean {
        ...
        if (!this.esTextoNombreValido(this.nuevoEmpleado.nombre)) {
            errores['nombre'] = 'Ingresa un nombre vÃ¡lido.';
        }

        if (!this.esTextoNombreValido(this.nuevoEmpleado.apellido)) {
            errores['apellido'] = 'Ingresa un apellido vÃ¡lido.';
        }

        if (!this.esCorreoValido(this.nuevoEmpleado.email)) {
            errores['email'] = 'Ingresa un correo vÃ¡lido.';
        }

        if (!this.esPasswordValido(this.nuevoEmpleado.password)) {
            errores['password'] = 'La contraseÃ±a debe tener al menos 5 caracteres.';
        }
    ...
    private validarCambiarPassword(): boolean {
        ...
        if (!this.cambiarPasswordForm.confirmarPassword.trim()) {
            errores['confirmarPassword'] = 'Debes confirmar la contraseÃ±a.';
    ...
    private esTextoNombreValido(valor: string): boolean {
        ...
        const regex = /^[A-Za-zÃÃ‰ÃÃ“ÃšÃ¡Ã©Ã­Ã³ÃºÃ‘Ã±ÃœÃ¼\s]+$/;
