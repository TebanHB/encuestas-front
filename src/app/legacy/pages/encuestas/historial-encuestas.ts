...
import { EncuestaResponse, EncuestaService, EstadoEncuesta } from '../../services/encuesta.service';
...
@Component({
    ...
    template: `
            ...
            <section class="card historial-hero">
                ...
                <div class="filters-grid">
                    <div class="filter-item">
                        ...
                        <input pInputText [(ngModel)]="filtroTitulo" (input)="aplicarFiltros()" class="w-full" placeholder="Ejemplo: satisfacciÃ³n" />
                    </div>
        ...
        <p-dialog header="Confirmar eliminaciÃ³n" [(visible)]="mostrarDialogoEliminar" [modal]="true" [style]="{ width: '30rem', 'max-width': '95vw' }" [closable]="!eliminandoEncuestaId" [draggable]="false" [resizable]="false">
            <div class="pt-2">
                <p class="m-0">
                    Â¿Seguro que deseas eliminar la encuesta
                    <strong>{{ encuestaSeleccionadaEliminar?.titulo }}</strong
                    >?
                </p>

                <p class="text-600 mt-3 mb-0">Esta acciÃ³n solo deberÃ­a hacerse en encuestas creadas por error.</p>
            </div>
