...
import { EncuestaDetalleResponse, EncuestaService, GuardarEncuestaRequest } from '../../services/encuesta.service';
        ...
        <div class="encuesta-builder">
            <section class="builder-header card">
                <div class="builder-header__info">
                    ...
                    <p>DiseÃ±a encuestas dinÃ¡micas con distintos tipos de preguntas, numeraciÃ³n configurable y vista previa en tiempo real.</p>
                </div>
            ...
            <div class="builder-body" *ngIf="!cargandoDetalle">
                <div class="builder-main">
                    <section class="card builder-section">
                        ...
                        <div class="form-block">
                            ...
                            <input pInputText [(ngModel)]="tituloEncuesta" (ngModelChange)="onDraftChanged()" class="w-full" placeholder="Ejemplo: Encuesta de satisfacciÃ³n del cliente" />
                        </div>
                        ...
                        <div class="question-grid">
                            <div class="form-block">
                                <label>NumeraciÃ³n general de preguntas</label>
                                <p-select [options]="formatosNumeracion" [(ngModel)]="formatoNumeracionGeneral" optionLabel="label" optionValue="value" appendTo="body" class="w-full" (onChange)="onDraftChanged()"></p-select>
                            </div>
                        </div>
                        ...
                        <div class="evaluation-box">
                            <div>
                                ...
                                <p>ActÃ­valo si esta encuesta funcionarÃ¡ como cuestionario o examen con respuestas correctas.</p>
                            </div>
                    ...
                    <section class="card builder-section">
                        ...
                        <div *ngIf="preguntas.length === 0" class="empty-state">
                            ...
                            <span>AÃºn no agregaste preguntas.</span>
                        </div>
                        ...
                        <div *ngFor="let pregunta of preguntas; let i = index" class="question-card">
                            ...
                            <div class="question-grid">
                                ...
                                <div class="form-block">
                                    ...
                                    <p-select [options]="tiposPregunta" [(ngModel)]="pregunta.tipo" optionLabel="label" optionValue="value" appendTo="body" class="w-full" (onChange)="onTipoPreguntaChange(pregunta)"></p-select>
                                </div>
                            </div>
                            ...
                            <div class="question-grid" *ngIf="muestraFormatoOpciones(pregunta.tipo)">
                                <div class="form-block">
                                    ...
                                    <p-select [options]="formatosOpciones" [(ngModel)]="pregunta.formatoOpciones" optionLabel="label" optionValue="value" appendTo="body" class="w-full" (onChange)="onDraftChanged()"></p-select>
                                </div>
                            </div>
                            ...
                            <div *ngIf="requiereOpcionesVisuales(pregunta.tipo)" class="options-box">
                                <div class="options-box__header">
                                    <div>
                                        ...
                                        <p>{{ pregunta.tipo === 'SI_NO' ? 'Pregunta fija de SÃ­ / No.' : 'Configura las opciones que verÃ¡ el usuario.' }}</p>
                                    </div>

                                    <button *ngIf="permiteEditarOpciones(pregunta.tipo)" pButton type="button" icon="pi pi-plus" label="Agregar opciÃ³n" size="small" (click)="agregarOpcion(i)"></button>
                                </div>

                                <div *ngIf="modoCalificable" class="correct-help">
                                    <i class="pi pi-info-circle"></i>
                                    <span *ngIf="pregunta.tipo === 'OPCION_UNICA' || pregunta.tipo === 'SI_NO'">Marca una sola opciÃ³n correcta.</span>
                                ...
                                <div *ngFor="let opcion of pregunta.opciones; let j = index" class="option-row">
                                    ...
                                    <div class="option-order-actions" *ngIf="!permiteEditarOpciones(pregunta.tipo)">
                                        <span class="option-static-label">{{ getOptionPrefix(j, pregunta.formatoOpciones) || 'â€¢' }}</span>
                                    </div>
                                    ...
                                    <input pInputText [(ngModel)]="opcion.texto" (ngModelChange)="onDraftChanged()" class="w-full" [placeholder]="'OpciÃ³n ' + (j + 1)" [disabled]="!permiteEditarOpciones(pregunta.tipo)" />
                            ...
                            <div *ngIf="pregunta.tipo === 'NUMERICA'" class="type-help-box">
                                ...
                                <span>El usuario responderÃ¡ con un valor numÃ©rico.</span>
                            </div>
                        </div>
                ...
                <aside class="builder-preview">
                    <section class="card preview-card">
                        ...
                        <p class="preview-subtitle">AsÃ­ se verÃ­a la encuesta para el usuario final.</p>

                        <div class="preview-box">
                            <div class="preview-head">
                                <h4>{{ tituloEncuesta || 'Sin tÃ­tulo' }}</h4>
                                <p>{{ descripcionEncuesta || 'Sin descripciÃ³n' }}</p>
                            </div>
                            ...
                            <div *ngFor="let pregunta of preguntas; let i = index" class="preview-question">
                                ...
                                <div *ngIf="pregunta.tipo === 'COMPLETAR_ORACION'">
                                    <input pInputText class="w-full" placeholder="Completa la oraciÃ³n" disabled />
                                </div>

                                <div *ngIf="pregunta.tipo === 'NUMERICA'">
                                    <input pInputText class="w-full" placeholder="Respuesta numÃ©rica" disabled />
                                </div>
                                ...
                                <div *ngIf="pregunta.tipo === 'OPCION_UNICA' || pregunta.tipo === 'SI_NO'">
                                    <div *ngFor="let opcion of pregunta.opciones; let j = index" class="preview-option">
                                        <label class="flex align-items-center gap-2">
                                            ...
                                            <span>{{ getOptionPrefix(j, pregunta.formatoOpciones) }}{{ opcion.texto || 'OpciÃ³n vacÃ­a' }}</span>
...
export class CrearEncuesta implements OnInit {
    ...
    tiposPregunta = [
        ...
        { label: 'OpciÃ³n Ãºnica', value: 'OPCION_UNICA' },
        { label: 'OpciÃ³n mÃºltiple', value: 'OPCION_MULTIPLE' },
        { label: 'SÃ­ / No', value: 'SI_NO' },
        { label: 'Completar oraciÃ³n', value: 'COMPLETAR_ORACION' },
        { label: 'NumÃ©rica', value: 'NUMERICA' }
    ];

    formatosNumeracion = [
        { label: 'Sin numeraciÃ³n', value: 'NINGUNA' },
    ...
    limpiarTodo(): void {
        const confirmar = window.confirm('Â¿Deseas limpiar todo y comenzar una encuesta nueva desde cero?');
        if (!confirmar) {
            return;
        }
    ...
    guardarBorrador(): void {
        ...
        if (!this.tituloEncuesta.trim()) {
            this.errorMessage = 'El tÃ­tulo de la encuesta es obligatorio.';
            this.cdr.detectChanges();
            return;
        }
        ...
        for (const pregunta of this.preguntas) {
            ...
            if (this.requiereOpcionesVisuales(pregunta.tipo)) {
                ...
                if (pregunta.tipo === 'SI_NO' && pregunta.opciones.length !== 2) {
                    this.errorMessage = `La pregunta "${pregunta.titulo}" debe tener exactamente SÃ­ y No.`;
                    this.cdr.detectChanges();
                    return;
                }
                ...
                if (this.modoCalificable) {
                    ...
                    if ((pregunta.tipo === 'OPCION_UNICA' || pregunta.tipo === 'SI_NO') && cantidadCorrectas !== 1) {
                        this.errorMessage = `La pregunta "${pregunta.titulo}" debe tener exactamente una opciÃ³n correcta.`;
                        this.cdr.detectChanges();
                        return;
                    }

                    if (pregunta.tipo === 'OPCION_MULTIPLE' && cantidadCorrectas === 0) {
                        this.errorMessage = `La pregunta "${pregunta.titulo}" debe tener al menos una opciÃ³n correcta.`;
                        this.cdr.detectChanges();
                        return;
                    }
                }
    ...
    private intentarRecuperarBorradorLocal(): void {
        ...
        try {
            ...
            const continuar = window.confirm('Se encontrÃ³ una encuesta sin terminar. Â¿Quieres continuar donde la dejaste?');
    ...
    private crearOpcionesSiNo(opcionesActuales: OpcionPregunta[]): OpcionPregunta[] {
        ...
        return [
            {
                texto: siActual?.texto?.trim() ? siActual.texto : 'SÃ­',
