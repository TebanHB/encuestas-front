            ...
            <ng-template #content>
                <div class="flex flex-col gap-6">
                    ...
                    <div>
                        ...
                        <p-select [(ngModel)]="product.inventoryStatus" inputId="inventoryStatus" [options]="statuses" optionLabel="label" optionValue="label" placeholder="Select a Status" appendTo="body" fluid />
                    </div>
