                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        ...
                        <div>
                            ...
                            <input pInputText id="email1" type="email" placeholder="Correo electrónico" class="w-full md:w-120 mb-8" [(ngModel)]="email" />
                            ...
                            <p-button [label]="loading ? 'Ingresando...' : 'Iniciar sesión'" styleClass="w-full" [disabled]="loading" (onClick)="onLogin()"></p-button>
                        </div>
                    </div>
                </div>
            </div>
